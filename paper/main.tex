...
\begin{figure}[h]
    ...
    \inferrule[type-let]
      {\Gamma \vdash e_1 : \tau_1 \\ \Gamma , x : \tau_1 \vdash e_2 : \tau_2 \\ \Gamma \vdash \tau_1 :: \star_2}
      {\Gamma \vdash ($\texttt{let $x = e_1 $ in $e_2$} $) : \tau_2}

    \inferrule[type-let-rec]
      {\Gamma , x : \tau_1 \vdash e_1 : \tau_1 \\ \Gamma , x : \tau_1 \vdash e_2 : \tau_2}
...
% Later on mention the problem of termination - the partially evaluated version may terminate when the original does not.
